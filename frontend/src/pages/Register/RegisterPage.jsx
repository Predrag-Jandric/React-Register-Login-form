    ...
    return (
        ...
        <main className='w-[90%] mx-auto my-10 gap-8 flex flex-col sm:w-[30rem]'>
            ...
            <form onSubmit={formik.handleSubmit} className='flex flex-col gap-2 bg-white py-3 px-6 drop-shadow-lg border-1 border-blue-300 rounded-5 '>
                ...
                <button className='bg-primary text-white py-2  rounded-5 mt-5 mb-2 hover:bg-primary_hover transition-colors' type='submit'>Register</button>
            </form>
            ...
            <div className=' text-center bg-white py-4 border-1 border-blue-300 rounded-5 drop-shadow-lg'>
                ...
                <Link to='/login' className='font-bold text-primary hover:text-primary_hover'>Click here to Log in</Link>
            </div>
